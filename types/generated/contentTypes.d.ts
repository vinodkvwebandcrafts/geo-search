...
export interface ApiBranchBranch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'branchName'>;
...
export interface ApiGeneralSiteSettingGeneralSiteSetting
  extends Struct.SingleTypeSchema {
  collectionName: 'general_site_settings';
  info: {
    displayName: 'General Site Setting';
    pluralName: 'general-site-settings';
    singularName: 'general-site-setting';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general-site-setting.general-site-setting'
    > &
      Schema.Attribute.Private;
    meta_social: Schema.Attribute.Component<'shared.meta-social', true>;
    og: Schema.Attribute.Component<'shared.open-graph', false>;
    publishedAt: Schema.Attribute.DateTime;
    recaptcha_secret_key: Schema.Attribute.Text;
    revalidate_url: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::general-site-setting.general-site-setting': ApiGeneralSiteSettingGeneralSiteSetting;
